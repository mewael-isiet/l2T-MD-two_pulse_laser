...
Atom::Atom(LAMMPS *lmp) : Pointers(lmp)
{
  ...
  frequency = NULL; dfreq = NULL; entropy  = NULL, mxe_temperature  = NULL, freq_force  = NULL, entropy_force = NULL;
  xi = fxi = NULL;
  ...
  frequency_flag = 0; entropy_flag = 0; mxe_temperature_flag = 0; freq_force_flag = 0; entropy_force_flag = 0;
  xi_flag = 0; fxi_flag = 0;
...
Atom::~Atom()
{
  ...
  // USER-MXE package
  memory->destroy(frequency);
  memory->destroy(dfreq);
  memory->destroy(entropy);
  memory->destroy(mxe_temperature);
  memory->destroy(freq_force);
  memory->destroy(entropy_force);
  memory->destroy(xi);
  memory->destroy(fxi);
...
void Atom::create_avec(const char *style, int narg, char **arg, int trysuffix)
{
  ...
  // USER-MXE package
  frequency_flag = 0; entropy_flag = 0; mxe_temperature_flag = 0; freq_force_flag = 0; entropy_force_flag = 0, xi_flag = 0, fxi_flag = 0; 
...
void *Atom::extract(char *name)
{
  ...
  // USER-MXE package  
  if (strcmp(name,"frequency") == 0) return (void *) frequency;
  if (strcmp(name,"dfreq") == 0) return (void *) dfreq;
  if (strcmp(name,"entropy") == 0) return (void *) entropy;
  if (strcmp(name,"mxe_temperature") == 0) return (void *) mxe_temperature;
  if (strcmp(name,"freq_force") == 0) return (void *) freq_force;
  if (strcmp(name,"entropy_force") == 0) return (void *) entropy_force;
  if (strcmp(name,"xi") == 0) return (void *) xi;
  if (strcmp(name,"fxi") == 0) return (void *) fxi;
