...
class Atom : protected Pointers {
 public:
  ...
  double *frequency, *dfreq, *entropy, *mxe_temperature, *freq_force, *entropy_force;
  double **xi, **fxi;
  ...
  int frequency_flag, entropy_flag, mxe_temperature_flag, freq_force_flag, entropy_force_flag, xi_flag, fxi_flag;
